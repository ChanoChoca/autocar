export default function Footer() {
  return (
    <footer className="bg-black text-white pt-20 pb-10 sm:text-xl md:text-2xl">
      <div className="container mx-auto pb-10 px-5">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-y-20">
          <div className="sm:col-span-2 lg:col-span-1 mb-10 lg:mb-0">
      ...
      <hr />
      <div className="container mx-auto flex flex-col text-center lg:justify-between pt-10 px-5 space-y-5">
        <p>Copyright © 2025 Autocar. Todo los derechos reservados</p>
        <div>
